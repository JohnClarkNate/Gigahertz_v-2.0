...
<div class="sidebar">
    ...
    <nav class="sidebar-nav">
        <div class="nav-section">
            ...
            <a href="#attendance-records" class="nav-item"> <!-- Anchor link -->
                <i class="fas fa-clock nav-icon"></i>
                <span>My Records</span>
            </a>
            <!-- Link to My Payroll Records -->
            <a href="#payroll-records" class="nav-item"> <!-- Anchor link -->
...
<div class="main-content">
    ...
    <div class="content">
        ...
        <?php else: ?>
            ...
            <div class="card" id="attendance-records"> <!-- Added ID for anchor -->
            ...
            <div class="card" id="payroll-records"> <!-- Added ID for anchor -->
                <div class="card-header">
                    <div class="card-title">
